...
- **Plan** = pesos por categoría sobre la Cartera **Núcleo** (suman 100 %; "otros" no tiene objetivo) + topes opcionales de Satélite y Play Money sobre el total. Sin plan definido no hay semáforo: la app lo pide.
