...
//    43 ISINs únicos. El de VFINX estaba duplicado (uno de ellos, US9229087286,
//    es en realidad VTSAX); se dejó solo el bueno en sep-2026.
// -----------------------------------------------------------------------------
const FAMILIAS: string[] = [
  ...
  // K Geográfica USA
  "US9229081081", // Vanguard 500 Index Investor (VFINX)
