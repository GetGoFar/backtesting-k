...
const INDEXED_FUNDS: Fund[] = [
  ...
  {
    id: "stock-mstr",
    name: "Strategy Inc. (antes MicroStrategy)",
    shortName: "Strategy/MicroStrategy (MSTR)",
    isin: "US5949724083",
    ticker: "MSTR",
    ter: 0,
    category: "RV EEUU",
  ...
  },
  {
    ...
    shortName: "AstraZeneca (AZN.L)",
    isin: "GB0009895292",
    ticker: "AZN.L",
    ter: 0,
    category: "RV Europa",
    type: "index",
    currency: "GBX", // cotiza en peniques en la LSE (auditoría EODHD sep-2026)
    distributing: true,
    terSource: "curated",
    terConfirmed: true,
  },
