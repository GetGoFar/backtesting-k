...
function ChartLoadingSkeleton({ height }: { height: string }) {
  return (
    <div className={`bg-white rounded-xl border border-slate-200 shadow-sm p-6 ${height} flex items-center justify-center`}>
  ...
  return (
    <div className="min-h-screen flex flex-col">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 hidden sm:block">El Proyecto K</p>
              </div>
            </div>
            <a
      ...
      <main className="flex-1 container mx-auto px-4 py-6 sm:py-8 max-w-7xl">
        ...
        {/* Error Banner */}
        {error && (
          <div className="mb-6 p-4 bg-red-50 border border-red-200 rounded-xl text-red-700 flex items-start gap-3 animate-in fade-in slide-in-from-top-2 duration-300">
            <svg
          ...
          <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-4 sm:p-6">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    max={10000000}
                    step={100}
                    className="w-full px-3 py-2 pr-12 text-sm sm:text-base border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                  />
                  <span className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-400 text-xs sm:text-sm">
                    EUR
                  </span>
                </div>
              </div>
            ...
            <div className="mt-6 sm:mt-8 flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4">
              <button
                ...
                className={`w-full sm:w-auto px-6 sm:px-8 py-3 rounded-xl text-sm sm:text-base font-semibold transition-all flex items-center justify-center gap-2 ${
        ...
        <section ref={resultsRef} className="mb-6 sm:mb-8">
          <h3 className="text-sm font-semibold text-slate-500 uppercase tracking-wider mb-3 sm:mb-4">
            3. Resultados
          </h3>
          ...
          {!results && !isLoading && (
            <div className="bg-white rounded-xl border border-slate-200 border-dashed p-8 sm:p-12 text-center">
              <svg
          ...
          {isLoading && (
            <div className="bg-white rounded-xl border border-slate-200 p-8 sm:p-12 text-center">
              <div className="inline-flex items-center justify-center w-14 sm:w-16 h-14 sm:h-16 rounded-full bg-blue-50 mb-3 sm:mb-4">
                <svg
                  className="animate-spin h-7 sm:h-8 w-7 sm:w-8 text-blue-600"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
                >
            ...
            >
                  ...
                  <div className="flex gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <ul className="text-blue-700 text-xs sm:text-sm space-y-1">
                        {results.warnings.map((w: BacktestWarning, i: number) => (
              ...
              {results.effectiveDateRange && (
                <div className="flex items-center justify-between text-xs text-slate-500 px-1">
                  <span>
                    Periodo analizado: <strong>{formatDateForDisplay(results.effectiveDateRange.startDate)}</strong> — <strong>{formatDateForDisplay(results.effectiveDateRange.endDate)}</strong>
                  </span>
                  <span>
              ...
              {/* 4. Gráficos secundarios en grid */}
              <div className="grid gap-4 sm:gap-6 lg:grid-cols-2">
              ...
              {/* 6. Disclaimer dentro de resultados */}
